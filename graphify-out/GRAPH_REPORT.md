...
## Corpus Check
- 104 files · ~15,171 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 244 nodes · 154 edges · 105 communities (94 shown, 11 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bef5b112`
...
7. `CustomHTTPRequestHandler` - 4 edges
8. `CustomHTTPRequestHandler` - 4 edges
9. `MyApp` - 4 edges
10. `CustomErrorMiddleware` - 4 edges
...
Cohesion: 0.1
Nodes (19): code:bash (# 查看详细错误信息), code:bash (# 手动测试连接), code:bash (# 自定义端口映射), code:block4 (container/), code:bash (# 访问主页), code:bash (# 检查端口占用), Python HTTP Server Docker 部署指南, 📋 前置要求 (+11 more)
...
Cohesion: 0.4
Nodes (5): code:yaml (services:), code:yaml (services:), 多实例部署, 📈 性能优化, 资源限制

## Knowledge Gaps
- **45 isolated node(s):** `Config`, `计算表达式，格式: 'a operator b`, `Run administrative tasks.`, `ASGI config for hello_world project.  It exposes the ASGI callable as a module-l`, `Django settings for hello_world project.  Generated by 'django-admin startprojec` (+40 more)
...
- **Why does `Python HTTP Server Docker 部署指南` connect `Community 0` to `Community 8`, `Community 12`, `Community 13`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `🔍 监控和日志` connect `Community 8` to `Community 0`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `🛠️ 快速开始` connect `Community 12` to `Community 0`?**
