# Graph Report - fastapi-project  (2026-07-28)

## Corpus Check
- 66 files · ~38,839 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 325 nodes · 542 edges · 22 communities (21 shown, 1 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 20 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8a12e908`
...
Cohesion: 0.1
Nodes (34): createPost(), favoritePost(), fetchPostDetail(), fetchPosts(), likePost(), unfavoritePost(), unlikePost(), EmptyIllustration() (+26 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (35): BaseSettings, get_settings(), Settings, Inject the current request id into every log record., Configure root logging once for the application., Configure root logging once for the application., RequestIdFilter, set_request_id() (+27 more)

### Community 2 - "Community 2"
Cohesion: 0.09
Nodes (30): login(), register(), fetchMyFavorites(), fetchMyPosts(), attachAuthHeader(), BIZ_SUCCESS_CODES, BizApiError, envelopeMessage() (+22 more)

### Community 3 - "Community 3"
Cohesion: 0.1
Nodes (23): BaseModel, ApiResponse, ok(), PageData, login(), register(), my_favorites(), my_posts() (+15 more)
...
## Knowledge Gaps
- **88 isolated node(s):** `Create the shared async Redis client (call once on app startup).`, `Close Redis client and connection pool on app shutdown.`, `FastAPI dependency that yields the shared Redis client.`, `Inject the current request id into every log record.`, `Configure root logging once for the application.` (+83 more)
...
- **Why does `InteractionOut` connect `Community 6` to `Community 3`?**
